import { _ as n, c as a, o as s, a as t } from "./app.bca14394.js";
const h =
    '{"title":"build","description":"","frontmatter":{},"headers":[{"level":2,"title":"build","slug":"build"},{"level":3,"title":"operate step with rollup","slug":"operate-step-with-rollup"},{"level":3,"title":"webpack","slug":"webpack"},{"level":3,"title":"rollup","slug":"rollup"}],"relativePath":"build.md","lastUpdated":1641269899800}',
  o = {},
  e = t(
    `<h2 id="build" tabindex="-1">build <a class="header-anchor" href="#build" aria-hidden="true">#</a></h2><ul><li>refer to <a href="https://gist.github.com/aleclarson/9900ed2a9a3119d865286b218e14d226" target="_blank" rel="noopener noreferrer">rollup-typescript</a></li></ul><h3 id="operate-step-with-rollup" tabindex="-1">operate step with rollup <a class="header-anchor" href="#operate-step-with-rollup" aria-hidden="true">#</a></h3><h4 id="feature" tabindex="-1">Feature <a class="header-anchor" href="#feature" aria-hidden="true">#</a></h4><ul><li>support typescript</li><li>generate different format bundle</li><li><a href="https://api-extractor.com/pages/configs/api-extractor_json/#dts-rollup-section" target="_blank" rel="noopener noreferrer">api extractor</a></li></ul><h4 id="install" tabindex="-1">Install <a class="header-anchor" href="#install" aria-hidden="true">#</a></h4><ol><li>Run this in your terminal:</li></ol><div class="language-shell"><pre><code><span class="token function">npm</span> i typescript rollup rollup-plugin-typescript2 tslib -D
